...
def confirmer_placement():
    ...
    x2 = (canvas2.winfo_y()-100)//taille_de_carres
    y2 = (canvas2.winfo_x()-10)//taille_de_carres
    width2 = canvas2.winfo_width()
    height2 = canvas2.winfo_height()
    x3 = (canvas3.winfo_y()-100)//taille_de_carres
    y3 = (canvas3.winfo_x()-10)//taille_de_carres
    width3 = canvas3.winfo_width()
    height3 = canvas3.winfo_height()
    x4 = (canvas4.winfo_y()-100)//taille_de_carres
    y4 = (canvas4.winfo_x()-10)//taille_de_carres
    width4 = canvas4.winfo_width()
    height4 = canvas4.winfo_height()
    x5 = (canvas5.winfo_y()-100)//taille_de_carres
    y5 = (canvas5.winfo_x()-10)//taille_de_carres
