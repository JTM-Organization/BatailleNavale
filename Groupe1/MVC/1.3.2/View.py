...
def creation_ecran_credits():
    ...
    def creation_canvas_frame_credits():
        # On crée un canvas qui s'étend sur tout le frame (il permettra le placement du texte et des images)
    ...
    def images_frame_credits():
        ...
        for i in range(len(image_avatar)):
            canvas_credits.create_image(coord_x2[i], coord_y2[i], image = image_avatar[i])
    ...
    def creation_boutons_frame_credits():
            ...
            global bouton_retour_frame_credits, bouton_lancer_frame_credits
            ...
            bouton_lancer_frame_credits = Button(canvas_credits,
                                                 ...
                                                 activeforeground = "#141414",
                                                 activebackground = "#ffcc66",
                                                 command = lambda:root.after(1000, debut_animation))
