...
#Implémentation d'une musique dans le menu (jusqu'au lancement d'une partie)
def play_music():
...
def creation_ecran_jeu():
    ...
    def creation_canvas_frame_jeu():
        ...
        score.grid(row = 1, column = 5, sticky = "nsew")
        
        # On crée un texte dans le canvas (les canvas textes causent moins de problèmes dans le positionnement que les labels)
        score.create_text(70, 40, text = "Score : 0", font = ("Andi 20 bold"), fill = "white")
