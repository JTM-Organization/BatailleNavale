...
#barre de progression des points de vie des joueurs
global progresJoueur,progresBot

#compteur de tour pour les statistiques
global tour
tour=1

#liste des images des difficultés et des difficultés pour raccourcir le code
global listeDif,listeImageDif

#récupération du chemin absolu pour les images
global chemin
path2 = os.path.realpath(__file__)
split_string = path2.split("\\")
chemin=""
for j in range(len(split_string)-1):
    chemin+=split_string[j]+"\\"
