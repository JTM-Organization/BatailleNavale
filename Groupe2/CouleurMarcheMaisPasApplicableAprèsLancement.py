...
Plateau = Frame(nb, width=960, height=1000)
Plateau2 = Frame(nb, width=960, height=1000)
Parametres = Frame(nb, width=960, height=1000,bg="#AAAAAA")
...
P1 = Button(Plateau2, text="Retourner sur votre plateau", command=select_jouer)
P2 = Button(Plateau, text="Observer le plateau de l'adversaire", command=select_plateau2)
Retour1 = Button(Plateau, text="Retour", command=select_retour)
Retour2 = Button(Plateau2, text="Retour", command=select_retour)
...
cnv1 = Canvas(Plateau, width = 2000, height = 2000)
cnv2 = Canvas(Plateau2, width = 2000, height = 2000)
cnvParametres = Canvas(Parametres, width = 2000, height = 2000)
...
couleurEau = Button(cnvParametres, text = "Couleur de l'eau",command =choose_color)
couleurBateau= Button(cnvParametres, text = "Couleur des bateaux",command = choose_color2)
couleurEau.pack()
couleurBateau.pack()
